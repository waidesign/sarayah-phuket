...
export default function SustainabilityPage() {
  return (
    <>
      <Seo
        title="Sustainability & Ownership | Sarayah Phuket Villas"
        description="How Sarayah's owner-managed model, natural-airflow architecture, and local partnerships shape a lower-impact stay in Thalang District, Phuket."
        path="/sustainability"
      ...
      <section className="py-20 sm:py-28 px-6 sm:px-8 bg-white">
        <div className="max-w-[1000px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          <Reveal className="lg:col-span-2 space-y-5">
            ...
            <h2 className="text-3xl sm:text-4xl font-headline italic text-on-surface">Direct ownership, <span className="font-light not-italic">direct accountability.</span></h2>
      ...
      <section className="py-24 sm:py-32 px-6 sm:px-8 bg-surface-container-low text-center">
        <Reveal>
          ...
          <Button variant="primary" to="/villas">
