...
export default function BlogPage() {
  return (
    <>
      <Seo
        title="The Journal | Phuket Travel Guides from Sarayah Phuket Villas"
        description="Villa guides, location comparisons, and Thalang District lifestyle stories from the team behind Sarayah Phuket Villas."
        path="/blog"
