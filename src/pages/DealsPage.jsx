...
export default function DealsPage() {
  return (
    <>
      <Seo
        title="Special Offers & Direct Booking Deals | Sarayah Phuket Villas"
        description="Stay 7 pay 6, early-bird discounts, and long-stay rates for Sarayah's luxury villas in Thalang District, Phuket — available only when you book direct."
        path="/deals"
