...
import HostexBookingWidget from '../components/HostexBookingWidget';
import Seo from '../components/Seo';
import Button from '../components/Button';
import LocationsSection from '../components/LocationsSection';
import { VILLAS_DATA } from '../data/villas';
import { parseInlineLinks } from '../utils/seo';
import { lodgingBusinessSchema, faqPageSchema, breadcrumbSchema } from '../data/schema';
    ...
    <>
      <Seo
        ...
        schema={[
          lodgingBusinessSchema({
            ...
            image: villa.heroImage,
            path: `/villas/${villa.slug}`,
            address: LOCATIONS[villa.slug]?.address,
          }),
          faqPageSchema(villa.faqs),
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          <Reveal className="space-y-8">
            ...
            <h2 className="font-headline text-4xl sm:text-5xl leading-[1.1] italic text-on-surface">
              ...
              <span className="font-light not-italic">{villa.ethos.italicTitle}</span>
            </h2>
      ...
      <section className="py-28 sm:py-36 lg:py-44 px-6 sm:px-8 bg-background">
        <div>
          ...
          <Reveal delay={100} className="grid grid-cols-2 gap-4 sm:gap-5">
            {villa.tourImages.map((img, i) => (
              <div key={img.image + i} className="relative aspect-[4/3] rounded-xl overflow-hidden group">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <Reveal className="order-1 lg:order-2 space-y-6">
            ...
            <h3 className="text-4xl font-headline text-on-surface leading-tight italic">
              ...
              <span className="font-light not-italic">{villa.secondary.italicTitle}</span>
            </h3>
      ...
      {/* ===== CHECK AVAILABILITY ===== */}
      <section id="availability" className="py-28 sm:py-36 lg:py-44 px-6 sm:px-8 bg-white text-center scroll-mt-24">
        <Reveal className="max-w-4xl mx-auto mb-10">
          ...
          <p className="text-on-surface-variant leading-relaxed">Most private pool villas in Phuket book up months in advance. Check your dates and lock in your sanctuary — no middleman, no extra fees.</p>
        </Reveal>
        <Reveal delay={100} className="max-w-2xl mx-auto">
          <HostexBookingWidget slug={villa.slug} />
        </Reveal>
      </section>
      ...
      <section className="py-24 px-6 sm:px-8 bg-white">
        <Reveal className="max-w-4xl mx-auto text-center">
          ...
          <Button variant="primary" to={villa.crossLink.href}>
            {villa.crossLink.cta}
          </Button>
        </Reveal>
      </section>
      ...
      <section className="py-32 sm:py-40 px-6 sm:px-8 bg-primary text-white text-center">
        <Reveal>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Button variant="tertiary" size="lg" href="#availability" className="w-full sm:w-auto">
              Request a Booking
            </Button>
            <Button variant="secondary" dark size="lg" to="/villas" className="w-full sm:w-auto">
