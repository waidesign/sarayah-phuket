...
export default function PhuketArticlePage() {
  ...
  const crumbs = [
    ...
    { name: `${article.title} ${article.italicTitle}`.trim(), path: `/phuket/${slug}` },
  ];

  const schema = [
    breadcrumbSchema(crumbs),
    ...(article.faqs ? [faqPageSchema(article.faqs)] : []),
  ];
  ...
  return (
    <>
      ...
      {article.heroImage ? (
        ...
        <section className="bg-primary text-white min-h-[70vh] flex items-center px-6 sm:px-10 lg:px-20">
