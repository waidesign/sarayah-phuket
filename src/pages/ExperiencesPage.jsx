...
export default function ExperiencesPage() {
  return (
    <>
      <Seo
        title="Curated Phuket Experiences | Sarayah Phuket Villas"
        description="Private yacht charters, in-villa chefs, wellness rituals, island tours, and car & taxi transfers — curated experiences for guests of Sarayah Phuket Villas in Thalang District."
        path="/experiences"
