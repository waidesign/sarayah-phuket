...
export const EXPERIENCES_DATA = {
  'private-yacht-charters': {
    ...
    meta: {
      title: 'Private Yacht Charters in Phuket | Sarayah Phuket Villas',
      description: "Charter a private yacht from Ao Po Grand or Royal Phuket Marina to Phang Nga Bay, Phi Phi, or the Racha Islands — arranged by your Sarayah Phuket Villas concierge.",
    },
    ...
    highlights: {
      title: 'Where to Go',
      items: [
        { title: 'Phang Nga Bay', body: 'Catamaran through shallow tidal caves, with a secret sunrise route to James Bond Island before the tour fleets arrive.' },
        { title: 'Phi Phi Cluster', body: 'High-speed motor yachts, under 45 minutes transit, to the secluded coves of Phi Phi Don and Bamboo Island.' },
        { title: 'Racha Islands', body: 'The best visibility for diving and snorkeling, with professional dive masters and high-end equipment.' },
      ],
    },
    featureTiles: [
  ...
  'in-villa-culinary': {
    ...
    italicTitle: 'Feasts.',
    meta: {
      title: 'Private Chef & In-Villa Dining, Phuket | Sarayah Phuket Villas',
      description: 'Book a private chef for Thai or Western fine dining on your poolside terrace in Thalang, Phuket — from a floating breakfast to an 8-course Southern Thai degustation.',
    },
  ...
  'wellness-spa': {
    ...
    meta: {
      title: 'Private Spa & Wellness Treatments, Phuket | Sarayah Phuket Villas',
      description: 'In-villa Thai massage, aromatherapy, and wellness rituals delivered to your private poolside deck in Thalang District, Phuket — booked through your Sarayah concierge.',
    },
  ...
  'island-expeditions': {
    ...
    italicTitle: 'Expeditions.',
    meta: {
      title: 'Phi Phi & James Bond Island Tours from Phuket | Sarayah Phuket Villas',
      description: "Private charters to Phi Phi, Phang Nga Bay's hidden Hongs, and James Bond Island — tide-timed routes from Thalang District to avoid the crowds.",
    },
  ...
  'car-rentals': {
    ...
    italicTitle: 'Fleet.',
    meta: {
      title: 'Car & Scooter Rentals in Thalang, Phuket | Sarayah Phuket Villas',
      description: 'Self-drive scooters and cars, owner-managed and booked direct — the easiest way to explore Northern Phuket from your Sarayah villa in Thalang District.',
    },
  ...
  'taxi-transfers': {
    ...
    meta: {
      title: 'Airport Transfers & Private Taxis, Phuket | Sarayah Phuket Villas',
      description: 'Private airport transfers from Phuket International Airport (HKT), plus hourly car-and-driver hire and beach club transport — arranged for Sarayah Phuket Villas guests.',
    },
