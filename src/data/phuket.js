...
export const PHUKET_DATA = {
  '2-bedroom-private-pool-villa-phuket': {
    ...
    italicTitle: 'Located.',
    meta: {
      title: '2-Bedroom Private Pool Villa Location Guide, Phuket | Sarayah',
      description: 'Drive times, nearby beaches, and what a small-group stay in a 2-bedroom Thalang District villa actually looks like day to day.',
    },
    heroImage: '/assets/media/villas/2-bedroom/IMG_8219.jpg',
    paragraphs: [
      'A [2-bedroom private pool villa](/villas/2-bedroom-private-pool-villa) suits small groups of 4–6 precisely because it\'s purpose-built for intimacy — not a scaled-down version of something bigger. Two equal master suites, a full-length pool, and a kitchen designed to actually cook in.',
    ...
    ctaButtons: [
      { label: 'View Villa & Dates', href: '/villas/2-bedroom-private-pool-villa' },
  ...
  'best-villas-thalang-district': {
    ...
    meta: {
      title: 'Thalang District, Phuket: Location Guide & Key Numbers | Sarayah',
      description: 'Flat terrain, west-coast beaches, and a 25-minute airport transfer — the practical case for choosing Thalang District over southern Phuket, by the numbers.',
    },
    ...
    paragraphs: [
      ...
      'For the full breakdown of terrain, noise, and drive times versus the south, see our [Cape Panwa vs. Thalang comparison](/blog/thalang-vs-southern-phuket-luxury-guide).',
    ],
    stats: [
  ...
  'private-pool-villas-phuket': {
    ...
    meta: {
      title: 'How to Choose a Private Pool Villa in Phuket | Sarayah',
      description: "What to check before booking a 'private pool villa' in Phuket — real walls vs. hedges, a usable kitchen, and why Thalang District is worth a look.",
    },
    heroImage: null,
    paragraphs: [
    ...
    villaTeasers: [
      { title: 'The 2-Bedroom Pool Villa', body: 'The intimate choice for couples or groups of 4-6, with a private pool and tropical gardens.', href: '/villas/2-bedroom-private-pool-villa' },
  ...
  'surin-beach-guide': {
    ...
    meta: {
      title: "Surin Beach Guide, Phuket: Millionaire's Row | Sarayah",
      description: "Surin Beach's granite headlands, the hidden Pansea Beach trail, and the best swim season — plus why staying inland in Thalang beats a cliffside perch.",
    },
