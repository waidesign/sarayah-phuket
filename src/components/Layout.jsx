...
export default function Layout() {
  ...
  const showStickyBar = stickyBarVisible && pathname === '/';
  ...
  return (
    <div className="bg-background text-on-surface font-body selection:bg-primary-fixed selection:text-on-primary-fixed">
      ...
      <div
        ...
        className={`fixed left-1/2 -translate-x-1/2 w-[calc(100%-2.5rem)] max-w-5xl z-40 transition-all duration-300 top-[95px] lg:top-[130px] ${
